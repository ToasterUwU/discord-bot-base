...
[Files]
Source: "dist\windows\bot\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "dist\windows\bot\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
